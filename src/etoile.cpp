...
Etoile::Etoile(Shader *shader_program, float height, float radius, int slices,int stack_count)
...
void Etoile::draw(glm::mat4& model, glm::mat4& view, glm::mat4& projection)
{
